...
const required = [
  ...
  "src/core/adjudicate.mjs", "src/core/bazi-adjudicator.mjs", "src/core/bazi-topic-adjudicator.mjs", "src/core/blind-check.mjs", "src/core/calculation-verifier.mjs", "src/core/claim-semantics.mjs", "src/core/meaning-layer.mjs",
  ...
  "src/core/ziwei-adjudicator.mjs", "src/core/ziwei-pattern-evidence.mjs", "src/core/ziwei-reading-adjudicator.mjs", "src/data/bazi-adjudication-rulepack.mjs", "src/data/bazi-climate-rulepack.mjs", "src/data/bazi-topic-rulepack.mjs",
  ...
  "src/data/meaning-registry.mjs", "src/data/ziwei-adjudication-rulepack.mjs", "src/data/ziwei-sanhe-rulepack.mjs", "src/data/ziwei-traditional-patterns-mingyu.mjs",
  ...
  "test/adjudicate-v05.test.mjs", "test/bazi-adjudication-v04.test.mjs", "test/bazi-luck-cycles.test.mjs", "test/bazi-professional-v05.test.mjs", "test/bazi-topic-v06.test.mjs", "test/bazi-upstream-golden-v06.test.mjs", "test/blind-check.test.mjs", "test/claim-semantics.test.mjs",
  ...
  "test/ziwei-adjudication-v04.test.mjs", "test/ziwei-phase-components.test.mjs", "test/ziwei-reading-adjudicator-v05.test.mjs", "test/ziwei-traditional-patterns-v06.test.mjs",
];
const errors = [];
...
try {
  ...
  if (SOURCES.length !== 16) errors.push(`expected 16 registered sources, found ${SOURCES.length}`);
  if (RULES.length !== 38) errors.push(`expected 38 registered rules, found ${RULES.length}`);
  ...
  if (!notices.includes("contains 16 machine-readable source **records**")) {
    errors.push("THIRD_PARTY_NOTICES.md has a stale source-record count");
  }
  if (!notices.includes("The 38 machine-readable rules")) {
