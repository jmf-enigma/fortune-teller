...
6. 多牌必须有关系综合；紫微目标日期按本命底色→大限四动态宫环境→流年四动态宫触发展开，阶段四化仍只取主题槽；禁止跨主题拼接、单星直断事件。
...
以下各项是 `0.4.0` 需要按 [BENCHMARK.md](../BENCHMARK.md) 与 [RELEASE_AUDIT.md](RELEASE_AUDIT.md) 逐项复核的工程差异。它们只支持具体维度的比较，不支持“整体最好”或“更准”的结论：
...
- 大规模知识库、完整古籍出处索引和分流派解释资料；当前只有 14 个窄来源记录、31 条适用性规则，以及一份刻意收窄的紫微解读地图；
