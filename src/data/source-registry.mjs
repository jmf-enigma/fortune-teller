...
const sources = [
  ...
  },
  {
    ...
    supported_rule_ids: ["R-BZ-001", "R-BZ-002", "R-BZ-009"],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
    verified_on: "2026-08-23",
  },
  {
    ...
    supported_rule_ids: ["R-BZ-005", "R-BZ-006", "R-BZ-009"],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
  ...
  },
  {
    ...
    supported_rule_ids: ["R-BZ-005", "R-BZ-006", "R-BZ-008", "R-BZ-009"],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
    verified_on: "2026-08-24",
  },
  {
    ...
    systems: ["bazi"],
    type: "historical_primary_text",
    title: "Qiong Tong Bao Jian (穷通宝鉴)",
    author_or_maintainer: "Wikisource transcription of the traditional text",
    url: "https://zh.wikisource.org/zh-hans/%E7%A9%B7%E9%80%9A%E5%AE%9D%E9%89%B4",
    scope: "Entry-level provenance for an independently transcribed 10 Day Stems x 12 solar-month source-mention and chart-location screening index.",
    limitations: "The arrays are not priority orders. Five audited entries require a missing solar-term segment; many others give different roles under different conditions. The machine rule therefore keeps climate use unresolved and does not import efficacy or historical outcome language.",
    supported_rule_ids: ["R-BZ-007"],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
    verified_on: "2026-08-24",
  },
  {
    ...
    supported_rule_ids: [
      "R-ZW-001", "R-ZW-002", "R-ZW-003", "R-ZW-005", "R-ZW-007", "R-ZW-008", "R-ZW-009", "R-ZW-010",
    ],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
    verified_on: "2026-08-23",
  ...
  {
    id: "SRC-ZW-MINGYU-PATTERNS-BD6963B",
    systems: ["ziwei"],
    type: "vendored_mit_rule_corpus",
    title: "Mingyu Zi Wei verified pattern catalog at bd6963b",
    author_or_maintainer: "Brhiza / mingyu contributors",
    url: "https://github.com/Brhiza/mingyu/blob/bd6963b9b562cbef77c50227b625c0d3e7b36021/packages/core/src/ziwei/iztro/pattern-detection.ts",
    scope: "MIT-licensed provenance for 55 source-located, mechanically reproducible natal pattern conditions and 32 explicit refusal boundaries adapted into calculation-only evidence.",
    limitations: "Traditional outcome prose is excluded from the local result route. A match proves only that the registered chart condition is present; names, counts, and classifications do not establish real-world events, probability, or overall auspiciousness.",
    supported_rule_ids: ["R-ZW-010"],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
    verified_on: "2026-08-24",
  },
  ...
  },
  {
    ...
    supported_rule_ids: ["R-WA-001", "R-WA-004", "R-WA-005"],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
    verified_on: "2026-08-23",
  },
  {
    ...
    supported_rule_ids: ["R-WA-001", "R-WA-003", "R-WA-005"],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
    verified_on: "2026-08-23",
  },
  ...
  },
  {
    ...
    scope: "Historical method provenance for the declared two-number indexing, upper/lower assignment, moving-line body/use assignment, mutual-hexagram extraction, and directional Five-Element relations.",
    limitations: "Editions and attribution vary. This project implements one bounded two-number profile; it does not implement time/object/omen casting, seasonal strength, timing judgment, or guaranteed outcomes.",
    supported_rule_ids: ["R-MH-001", "R-MH-002", "R-MH-003", "R-MH-005"],
    verification_status: "verified",
    verified_as: "provenance_and_scope_only",
    verified_on: "2026-08-23",
  },
