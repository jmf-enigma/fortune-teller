...
const ruleDefinitions = [
  ...
  {
    id: "R-BZ-009", system: "bazi",
    summary: "Organize only the three registered BaZi life topics from replayed located facts, separating visible stems, hidden-stem candidates, day-branch relations, and phase context without promoting co-presence to causation or an event.",
    allowed_scopes: ["topic_adjudication", "relationship_context"],
    required_fact_prefixes: ["/facts/pillars", "/facts/structure/relationships", "/facts/luck_cycles/target"],
    minimum_fact_references: 2,
    source_ids: ["SRC-BZ-SANMING-WIKISOURCE", "SRC-BZ-ZIPING-ZHENQUAN-NLC", "SRC-BZ-DITIAN-SUI-WIKISOURCE"],
    interpretation_ceiling: "typed_adjudication_binding_required",
    permitted_epistemic_status: ["unresolved"],
    protective: true,
  },
  {
  ...
  },
  {
    ...
    required_fact_prefixes: [
      "/facts/topic_units", "/facts/palaces", "/facts/structure/palace_relations",
      "/facts/structure/empty_palace_contexts",
    ],
  ...
  {
    id: "R-ZW-010", system: "ziwei",
    summary: "Evaluate each source-located named-pattern condition independently and preserve non-match and refusal boundaries without event inference.",
    allowed_scopes: ["named_pattern_evidence", "calculation_audit"],
    allowed_profile_ids: ["ziwei-default-v1", "ziwei-zhongzhou-v1"],
    required_fact_prefixes: ["/facts/pattern_evidence", "/facts/palaces", "/facts/structure/palace_relations"],
    required_fact_groups: [["/facts/pattern_evidence"], ["/facts/palaces"], ["/facts/structure/palace_relations"]],
    minimum_fact_references: 3,
    source_ids: ["SRC-ZW-IZTRO-2.6.0", "SRC-ZW-MINGYU-PATTERNS-BD6963B"],
    interpretation_ceiling: "calculation_only",
    permitted_epistemic_status: ["calculation_fact", "traditional_rule", "unresolved"],
    protective: true,
  },
  {
